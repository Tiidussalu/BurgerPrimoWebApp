    ...
    <div class="relative w-full max-w-md">
      ...
      <div class="bg-[#121212] border border-[#1a1a1a] rounded-2xl shadow-2xl p-8">
        ...
        <div class="text-center mb-8">
          ...
          <h1 class="text-2xl font-bold text-white mb-2">Unustasid parooli?</h1>
        ...
        <div
          v-if="status"
          class="mb-6 p-4 bg-green-500/10 border border-green-500/20 rounded-xl flex items-center gap-3 text-green-400 text-sm"
        >
        ...
        <form @submit.prevent="submit">
          ...
          >
            ...
            <span>{{ form.processing ? 'Saatmine...' : 'Saada lähtestamise link' }}</span>
          </button>
        </form>
